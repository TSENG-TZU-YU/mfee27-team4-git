...
$sqlSelect="SELECT * FROM place_product";
$resultSelect = $conn->query($sqlSelect) or die($conn->error);
$rows=$resultSelect->fetch_all(MYSQLI_ASSOC);
        ...
        <div class="row d-flex">
            ...
            <main class="col-10 px-5 py-4">
                ...
                <div class="container">
                    ...
                    <div class="row">
                        <!-- 文字按鈕 -->
                        <a class="col-2 btn btn-green me-2" href="creat-place.php">
                            <img class="bi pe-none mb-1" src="../icon/create-icon.svg" width="16" height="16"></img>
                            新增
                        </a>
                        <a href="javascript:void(0);" onclick="checkall(this)" title="刪除選定資料" style="font-weight:normal" class="col-2 btn btn-green me-2">
                        <input type="checkbox" id="ckb_selectAll" onclick="checkall(this)" title="選中/取消選中">
                            <img class="bi pe-none mb-1" src="../icon/update-icon.svg" width="16" height="16"></img>
                            全選
                        </a>
                        <a class="col-2 btn btn-red me-2" href="#">
                            <img class="bi pe-none mb-1" src="../icon/delete-icon.svg" width="16" height="16"></img>
                            批次刪除
                        </a>
                        <!-- 無文字按鈕 -->
                        <form action="ins-shop.php" class="col-3 me-2 "  >
