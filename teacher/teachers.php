                ...
                <div class="container">
                    <div class="row">
                        <form action="teacher-search.php" method="get">
                            <div class="row">
                                <p class="col-8 m-auto">本頁 <?= $pageTeacherCount ?> 筆資料，總共 <?= $teacherCount ?> 筆資料</p>
                            ...
                            <div class="d-flex justify-content-between">
                                <div class="me-3">
                                    <select class="form-select" aria-label="Default select example" name="course">
                                        <option selected value="">教授課程師資</option>
                    ...
                    <div aria-label="Page navigation example text-end" class="d-flex mt-5  justify-content-center">
                        <ul class="pagination">
                            ...
                            <?php for ($i = 1; $i <= $totalPage; $i++) : ?>
                                <li class="page-item"><a class="page-link <?php if ($page == $i) echo "active"; ?>" href="teachers.php?page=<?= $i ?>"><?= $i ?></a></li>
                            <?php endfor; ?>
                            <li class="page-item">
