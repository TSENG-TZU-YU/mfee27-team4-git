...
$id = $_GET["id"];
$sql = "SELECT * FROM course_product WHERE id=$id";
        ...
        <div class="row d-flex">
            ...
            <main class="col-10 px-5 py-4">
                ...
                <div class="container">
                    ...
                    <div class="row ">
                        <!-- 文字按鈕 -->
                        <a class="col-1 btn btn-green mx-3" href="course-detail.php?id=<?= $row["id"] ?>">
                ...
                <div class="container mt-5  ">
                    <?php if ($courseCount > 0) :  $row;?>
                        <form action="doupdate-course.php" method="post">
                            ...
                            <input name="id" type="hidden" value=" <?= $row["id"] ?>">
                                <table class="table table-bordered panel">
                                    ...
                                    <tr>
                                        <th>開始時間</th>
                                        <td><input type="datetime-local" class="form-control text-center" value="<?= $row["begin_date"] ?>" name="begin_date"></td>
                                    </tr>
                                    <tr>
                                        <th>結束時間</th>
                                        <td><input type="datetime-local" class="form-control text-center" value="<?= $row["over_date"]?>" name="over_date"></td>
                                    </tr>
                                    <tr>
                                        <th>課程簡介</th>
